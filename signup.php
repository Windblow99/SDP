      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<form method="post" action="#">
			<table>
				...
				<tr><th colspan="2"><br/><br/><br/><center><a><input id="submit" type="submit" value="Sign Up" class="btn btn-default" role="button"/ style="padding: 10px 40px; background-color: #808080; color:white;"></a></center></th></tr>
			</table>
		</form>
